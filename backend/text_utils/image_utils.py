...
class ImageText(object):
    ...
    def write_text_box(self, xy, text, box_width, font_filename,
        ...
        height = y
        text_height_ = len(lines) * self.get_text_size(font_filename, font_size, "A")[1]
        largest_width = 0
        for index, line in enumerate(lines):
            curr_width = self.get_text_size(font_filename, font_size, line)[0]
            if curr_width > largest_width:
