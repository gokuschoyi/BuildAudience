...
function StepFive(props) {
    ...
    const customId = "custom-id-PSuccess";

    const Success = () => toastPSuccess.current = toast.success('Your project has been saved', {
        position: "top-right",
        autoClose: false,
        ...
        <div data-w-id="f2b31280-0b97-8741-e941-32cae7d4977d" className="slide-2 w-slide" id='stepFive'>
            {saveProjectPendingFlag ? <div className="d-flex justify-content-center" style={{ zIndex: '2', paddingTop: '200px' }}>
                ...
                <>
                    ...
                    <div id="newPost" className="slider-content-wrap">
