                ...
                {blogPostdata === '' ? <div className="section-3 wf-section">
                    ...
                    <>
                        ...
                        <div className="blog_sections wf-section">
                            <div className="container" style={{ backgroundColor: '#FFB3B3', color: 'white' }}>
                        ...
                        <div className="blog_sections wf-section">
                            <div className="container" style={{ backgroundColor: '#FFDBA4' }}>
                                <div className="row justify-content-center align-items-center">
                                    <div className="col-lg-6 col-md-10 col-sm-10">
                        ...
                        {/* <div className="blog_sections wf-section">
                            <div className="container" style={{ backgroundColor: '#FFE9AE' }}>
                                <div className="row justify-content-center align-items-center">
                                    <div className="col-lg-6 col-md-10 col-sm-10">
